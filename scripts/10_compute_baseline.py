...
def main():
    seed_all(42)
    print("Computing native-Norwegian baseline\n")
    ...
    sources: dict[str, list] = {
        "wikipedia_no": wiki_docs,
        "gutenberg_no": gut_docs,
    }
    ...
    # Save the structured baseline
    out_path = ROOT / "results" / "baseline_native.json"
    ...
    wiki_cm = all_metrics.get("wikipedia_no")
    gut_cm = all_metrics.get("gutenberg_no")
